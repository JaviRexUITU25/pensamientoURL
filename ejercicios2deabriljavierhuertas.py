...
print("Respuesta mas frecuente: ", masfrecuente)
print("Promedio: ", sum(answer)/len(answer))
cliente_menor = [i + 1 for i, r in enumerate(answer) if r < (sum(answer)/len(answer))]
porcentaje_menor = (len(cliente_menor) / n) * 100
print("Clientes que respondieron menor al promedio: ", cliente_menor)
